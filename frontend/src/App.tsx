...
export default function App() {
  ...
  const [theme, setTheme] = useState<ThemeType>("chalkboard");
  ...
  return (
    <div className="w-full min-h-screen bg-[#0A0A0A] text-white font-sans flex flex-col overflow-x-hidden antialiased selection:bg-blue-600/30">
      ...
      <header className="flex flex-col sm:flex-row justify-between items-center px-6 sm:px-8 py-4 sm:h-20 border-b border-white/10 gap-4">
        ...
        <nav className="flex items-center gap-4 sm:gap-8 text-[11px] font-bold uppercase tracking-widest text-white/50">
          <span className="text-white border-b-2 border-blue-600 pb-1 cursor-default">Dashboard</span>
          <button 
            ...
            <div className="space-y-6">
              ...
              <div>
                <label className="text-[10px] uppercase font-bold block mb-2 text-white/60 tracking-wider">
                  Whiteboard Skin Theme
                </label>
                <div className="grid grid-cols-2 gap-2" id="skin-themes-deck">
                  <button 
                    onClick={() => setTheme("chalkboard")}
                    className={`py-2 px-1 text-[10px] font-bold uppercase border tracking-tight transition-all rounded ${
                      theme === "chalkboard" ? "bg-white text-black border-white" : "border-white/20 text-white/80 hover:bg-white/5"
                    }`}
                  >
                    Chalkboard
                  </button>
                  <button 
                    ...
                    className={`py-2 px-1 text-[10px] font-bold uppercase border tracking-tight transition-all rounded ${
                      theme === "blueprint" ? "bg-white text-black border-white" : "border-white/20 text-white/80 hover:bg-white/5"
                    }`}
                  >
                    Blueprint
                  </button>
                  <button 
                    ...
                    className={`py-2 px-1 text-[10px] font-bold uppercase border tracking-tight transition-all rounded ${
                      theme === "glassmorphic" ? "bg-white text-black border-white" : "border-white/20 text-white/80 hover:bg-white/5"
                    }`}
                  >
                    Glass Space
                  </button>
                  <button 
                    ...
                    className={`py-2 px-1 text-[10px] font-bold uppercase border tracking-tight transition-all rounded ${
                      theme === "darkroom" ? "bg-white text-black border-white" : "border-white/20 text-white/80 hover:bg-white/5"
                    }`}
                  >
                    Laser Dark
                  </button>
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-2" id="narrator-type-deck">
                  <button 
                    ...
                    className={`py-2 px-1 text-[10px] font-mono border tracking-tight transition-all rounded ${
                      narrator === "natural" && !isMuted ? "bg-blue-600 text-white border-blue-500" : "border-white/10 text-white/60 hover:bg-white/5"
                    }`}
                  >
                    Professor AI
                  </button>
                  <button 
                    ...
                    className={`py-2 px-1 text-[10px] font-mono border tracking-tight transition-all rounded ${
                      narrator === "assistant" && !isMuted ? "bg-blue-600 text-white border-blue-500" : "border-white/10 text-white/60 hover:bg-white/5"
                    }`}
                  >
                    Assistant Calm
                  </button>
                  <button 
                    ...
                    className={`py-2 px-1 text-[10px] font-mono border tracking-tight transition-all rounded ${
                      narrator === "cyborg" && !isMuted ? "bg-blue-600 text-white border-blue-500" : "border-white/10 text-white/60 hover:bg-white/5"
                    }`}
                  >
                    Cosmic Synth
                  </button>
                  <button 
                    ...
                    className={`py-2 px-1 text-[10px] font-mono border tracking-tight transition-all rounded ${
                      narrator === "mute" || isMuted ? "bg-zinc-800 text-white border-zinc-700" : "border-white/10 text-white/60 hover:bg-white/5"
                    }`}
                  >
                    Muted
                  </button>
                ...
                <div className="flex gap-1 bg-white/5 p-1 rounded border border-white/10">
                  {[0.5, 1.0, 1.5, 2.0].map((sVal) => (
                    <button
                      ...
                      className={`flex-1 text-[10px] py-1 px-1 text-center font-mono rounded transition-colors ${
                        speed === sVal ? "bg-blue-600 text-white font-bold" : "text-white/50 hover:text-white"
                      }`}
                    >
                      {sVal}x
                    </button>
              ...
              <div>
                ...
                <div className="grid grid-cols-3 gap-2" id="video-quality-deck">
                  <button 
                    ...
                    className={`py-2 px-1 text-[10px] font-mono border tracking-tight transition-all rounded ${
                      videoQuality === "low" ? "bg-blue-600 text-white border-blue-500" : "border-white/10 text-white/60 hover:bg-white/5"
                    }`}
                  >
                    Low
                  </button>
                  <button 
                    ...
                    className={`py-2 px-1 text-[10px] font-mono border tracking-tight transition-all rounded relative ${
                      videoQuality === "medium" ? "bg-blue-600 text-white border-blue-500" : "border-white/10 text-white/60 hover:bg-white/5"
                    }`}
                  >
                    Medium
                  ...
                  <button 
                    ...
                    className={`py-2 px-1 text-[10px] font-mono border tracking-tight transition-all rounded relative ${
                      videoQuality === "high" ? "bg-blue-600 text-white border-blue-500" : "border-white/10 text-white/60 hover:bg-white/5"
                    }`}
                  >
                    High
                    {!isPremium && <span className="absolute -top-1.5 -right-1.5 text-[7px] bg-amber-500 text-black px-1 rounded font-sans font-bold">PRO</span>}
            ...
            <div className="space-y-3 flex-1 overflow-y-auto max-h-[220px] pr-1.5 scrollbar-thin" id="renders-queue-deck">
              {historyList.map((item, index) => (
                <div 
                  ...
                  className={`group flex items-center gap-3 p-3 bg-white/5 hover:bg-white/10 border transition-all cursor-pointer rounded-lg ${
                    solution?.equation.toLowerCase() === item.equation.toLowerCase() ? "border-blue-500 bg-blue-950/20" : "border-white/5"
                  }`}
                >
            ...
            solution.scenes.map((scene, idx) => {
              ...
              return (
                <button
                  ...
                  className={`h-full flex-1 min-w-[120px] border-l border-r px-3 flex flex-col justify-center transition-all duration-300 text-left rounded-[3px] cursor-pointer ${
                    isActive 
